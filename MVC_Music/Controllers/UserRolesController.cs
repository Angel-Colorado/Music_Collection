...
namespace MVC_Music.Controllers
{
    ...
    public class UserRolesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            // If a User gets the 'Security' role, would be able to get here, however
            //  they won't be allowed to change their own role(s)
            // This rule doesn't prevent them from changing somebody else's roles and
            //  viceversa
            if (User.Identity.Name == user.UserName)
            {
                ModelState.AddModelError("", $"You are not allowed to change your own role(s). " +
                                                 $"Please contact a Security role user.");
            }
